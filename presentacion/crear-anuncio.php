...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <main class="w3-container">
			...
			<div class="w3-row w3-panel w3-border w3-border-red" style="margin-top: 3%">
                <div class="w3-col w3-border w3-border-red" style="width: 16.66%">
                    <p></p>
                </div>
				<div id="form_4" class =" w3-col w3-center" style="width: 66.66%">
						...
						<p>
                            <div class="w3-row w3-container w3-center w3-border w3-border-green" style="">
								<div class="w3-col w3-center w3-border w3-border-indigo">
                                    <form id="form_4" class=""
                                        action="crear_anuncio.php"
                                        method="post">
                                        <div id="dropzone" style="height: 200px;">
                                            <div class="w3-center w3-border w3-border-red">
                                                ...
                                                <div class="w3-col w3-center w3-border w3-border-inmobshop">
                									<span><i class="material-icons inmobshop"
                										style = "font-size: 80px;padding-top: 120px;">
                                                        camera_alt</i>
                                                    </span>
                								</div>
                                            </div>
