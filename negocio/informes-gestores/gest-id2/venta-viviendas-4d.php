<?php
$concepto = 'Ventas';
$nombre_informe = 'viviendas de 4 dormitorios';
$texto_presentacion = 'El presente informe recoge un estudio sobre las viviendas'+
' en venta de cuatro dormitorios: agrupadas por localidad, tipo y mostrando los'+
' valores de venta mínimos, medios y máximos.';
// seleccionamos todas las viviendas en venta de cuatro dormitorios, las agrupamos
// por tipo, dentro de los tipos por localidad. De cada grupo obtenemos los precios
...
require "..\..\..\datos\db.php";
	...
	<html lang="en">
	  <head>
	    ...
	    <title>Informe de venta de viviendas de 4 dormitorios en el portal InmobShop</title>
