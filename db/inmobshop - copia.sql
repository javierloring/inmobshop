...
CREATE TABLE IF NOT EXISTS `servicios` (
  `id_servicio` TIñINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `contratos` (
  ...
  `id_servicio` TIñINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `busquedas` (
  ...
  `orientacion` ENUM('NORTE', 'SUR', 'ESTE', 'OESTE') NULL,
  `num_habitaciones` TIñINT NULL,
  `num_baños` TIñINT COLLATE utf8_spanish_ci NULL,
...
CREATE TABLE IF NOT EXISTS `registros` (
  ...
  `id_servicio` TIñINT UNSIGNED NULL,
